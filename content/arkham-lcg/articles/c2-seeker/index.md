---
title: "Chapter 2 Class Spotlight : Seeker"
date: 2026-04-20
draft: false
description: From efficient clue gathering in the Core Set to the introduction of horror as a functional resource in the Evergreen deck, this article examines how the class’s identity is implemented—and where its design begins to expand into new directions.
tags:
  - class-spotlight
  - seeker
  - chapter-2
...
{{< figure src="https://cdn.jsdelivr.net/gh/iskander/arkham-tabularium-assets@main/arkham-lcg/articles/c2-seeker/Seeker.png"
    alt="Seeker class banner — Chapter 2 Core"
    width="900" >}}

Now that the entire evergreen pool is out, let's put the Seeker class under the same lens we applied to the [Guardian last time]({{< ref "arkham-lcg/articles/c2-guardian" >}}). How does the Chapter 2 Core Manual characterize the class, and how does the card pool — across the Core Set and Carolyn Fern's Evergreen deck — actually realize it?
...
{{< figure src="https://cdn.jsdelivr.net/gh/iskander/arkham-tabularium-assets@main/arkham-lcg/articles/c2-seeker/local-map.jpg"
    alt="Local Map — Core Seeker investigation tools"
    float="left"
    width="300" >}}
...
{{< figure src="https://cdn.jsdelivr.net/gh/iskander/arkham-tabularium-assets@main/arkham-lcg/articles/c2-seeker/Psychoanalysis.jpg"
    alt="Psychoanalysis — Carolyn Fern horror suite"
    float="left"
    width="300" >}}
...
{{< figure src="https://cdn.jsdelivr.net/gh/iskander/arkham-tabularium-assets@main/arkham-lcg/articles/c2-seeker/working-a-hunch.jpg"
    alt="Working a Hunch — Clue Gatherer archetype cards"
    float="left"
    width="300" >}}
...
{{< figure src="https://cdn.jsdelivr.net/gh/iskander/arkham-tabularium-assets@main/arkham-lcg/articles/c2-seeker/Typewriter.jpg"
    alt="Typewriter — Tome tech archetype cards"
    float="left"
    width="300" >}}
